...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            #check if subset of previous S level
    ...
    def add_literal_level(self, level):
        ...
        for a_node in self.a_levels[level-1]:
            for s_node in a_node.effnodes:
                #connect new S nodes as children of A nodes
                a_node.children.add(s_node)
                #connect A nodes as parents of S nodes
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        #take union of intersections between sets of nodes' action effect
        #if length of resulting set is not 0 then there is an inconsistent effect
        return len(
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        #take the union of intersections between sets of action effects and sets of opposing preconditions
        #if length of resulting set is not 0 then there is a negation
        return len(
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            ...
            for i, s_level in enumerate(self.s_levels):
                for state in s_level:
                    if state.literal == goal:
                        level_sum += i
                        goal_found = True
                        break
                if goal_found:
